...
**Public extract:** 9,470 rows · **Live catalog:** 9,469 domains
...
- `claims.csv` — public CSV extract (9,470 rows)
- `claims.json` — public JSON extract (9,470 rows)
...
| design.claims   | available | $19.99    | $86.99        | 108            | 49     | 6      | name.com       |
...
| ----------------------- | ------------------------------------------------ |
| 9,470-row public sample | 9,469 live domains                               |
...
> Unique Domains. *Available .CLAIMS One-Word Domains*. Version 2026-04-14. Public GitHub extract for the exact Unique Domains search represented by this repository.
